...
// SVG copied from https://raw.githubusercontent.com/ant-design/ant-design-icons/master/packages/icons/svg/outline/sync.svg
export default function SwitchCameraIcon({ style }: Props) {
  return (
