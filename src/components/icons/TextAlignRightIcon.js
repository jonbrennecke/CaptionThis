...
// SVG copied from https://raw.githubusercontent.com/ant-design/ant-design-icons/master/packages/icons/svg/outline/align-right.svg
export default function TextAlignRightIcon({ style, color }: Props) {
  return (
